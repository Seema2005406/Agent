...
charging_spots = [
    {"id": 1, "available": True, "supported_cars": "Tesla"},
...
async def handle_response(ctx: Context, sender: str, msg: Message):
    ...
    if "tesla" not in request_text:
        response = "❌ Sorry, Tesla vehicles are only supported at this charging station."
